...
foreach ($q['list'] as $row) { ?>
    <tr
        ...
        foreach ($q['table'] as $k => $v) {
            ...
            if ($k == '_check') {
                $content .= '<td class="table_checkbox"><input type="checkbox" name="_check" value="' . $row['id'] . '"/></td>';
            } elseif ($k == '_edit') {
                //v1.4.56 - права добавления/редактирования
                if ($v === true or $v == 'edit') {
